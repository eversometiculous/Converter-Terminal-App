...
if input_format == "markdown" and output_format == "html":
    ...
    output_data = pdfkit.from_string(markdown.markdown(input_data), False, configuration=pdfkit_config)
    ...
    pdfkit.from_string(input_data, output_file, configuration=pdfkit_config)
else:
